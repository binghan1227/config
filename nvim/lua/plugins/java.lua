...
return {
  {
    ...
    config = function()
      ...
      local root_dir = require("lspconfig.util").root_pattern(unpack(root_markers))(vim.loop.cwd()) or vim.loop.cwd()
      ...
      local function on_attach(client, bufnr)
        ...
        local map = function(mode, lhs, rhs, desc)
          vim.keymap.set(mode, lhs, rhs, { buffer = bufnr, silent = true, noremap = true, desc = "java: " .. (desc or "") })
        end
